...
function App() {
  ...
  return (
    ...
    <div className="dark-matter-extension">
      <div className="grid-background"></div>
      <header className="header">
        <div className="logo">
          <img src={DarkLogo} style={{ height: "2.8em" }} alt="Logo" />
...
//     <div style={{ background: "#1E1E1E", minHeight: "25rem", display: "flex", flexDirection: "column", overflow:"auto", minWidth:"20rem", padding:"1.5rem" }}>  
//     <div style={{ background: "#1E1E1E", minHeight: "25rem", display: "flex", flexDirection: "column", overflow:"auto" }}>
...
//     <img src={DarkLogo} style={{ height: "2em" }} alt="Logo" />
//     <h1>DarkMatter</h1>
//   </div>
